...
- **Owner's landing-page brief (2026-09-08) is parked, not done:** `docs/landing-brief-2026-09-08.md` — new hero, "Fra skuffen til væggen", 3-step process, "Det skal stadig ligne dem", "Originalen bliver hjemme", trust block, FAQ, one CTA ("Se mit billede restaureret gratis"), mobile 320–430. The owner stopped it mid-analysis ("kun billeder, rør ikke hjemmesiden lige nu"); the facts section in that file is verified against the code and is where the next session starts. One thing from it already applies to the ads: **"21 dages fortrydelse" is not a term** — never write it anywhere.
