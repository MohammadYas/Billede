...
export function copy(season: Season = currentSeason()) {
  ...
  return {
    ...
    hero: {
      ...
      small: `${price} inkl. print i ${formatLabel(format)}, ramme og fragt. Det koster ikke noget at se, og du godkender resultatet, før vi printer.`,
    },
    tryghed: [
    ...
    preview: {
      ...
      next: `Det her er maskinens første bud. Bestiller du, retter ${navn} det til i hånden, og du godkender det på mail, før vi printer.`,
