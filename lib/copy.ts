...
export function copy(season: Season = currentSeason()) {
  ...
  return {
    ...
    hero: {
      ...
      small: `${priceFrom} alt inkl. – print, ramme og fragt. Tre størrelser. Det koster ikke noget at se.`,
    ...
    produkt: {
      ...
      note: `Restaurering, print, ramme, gavekort med din hilsen, indpakning og fragt – ét beløb, ingen tillæg.`,
    },
    ...
    processing: {
      ...
      wait: 'Det tager normalt omkring et minut.',
