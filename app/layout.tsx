...
export const metadata: Metadata = {
  ...
  title: { default: 'Billedearv – restaurering af gamle billeder, leveret i ramme', template: '%s – Billedearv' },
  ...
  applicationName: 'Billedearv',
  authors: [{ name: 'Billedearv' }],
  category: 'shopping',
  openGraph: {
    title: 'Billedearv – gamle billeder, restaureret og indrammet',
