...
import { jobSecret, runJob, secretMatches, type JobKind } from '../../lib/jobs';
...
export default async (req: Request) => {
  if (!secretMatches(req.headers.get('x-job-secret'), jobSecret())) return new Response('unauthorized', { status: 401 });
