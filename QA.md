...
| G1 | Favicon/OG/title | ✓ | `favicon.svg` wordmark G, `og.jpg` before/after, title "Billedearv – gamle billeder, restaureret og indrammet" |
...
| Punkt | Resultat |
|---|---|
| Gmail-adresse → hej@billedearv.dk | én kilde (`founder.md`); `git grep` over alle sporede filer: 0 forekomster. Afsender: `Mohammad Yassin · Billedearv <hej@billedearv.dk>` |
...
| Vandmærke | tiled "BILLEDEARV · PREVIEW" 18 % over hele previewet (zoom skalerer samme fil); godkendelsesbillede 1200 px med 10 % mærke |
